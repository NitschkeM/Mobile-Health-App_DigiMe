...
export class StepsSummaryView extends React.Component<any, any> {
    ...
    public render() {
        return (
            <View style={styles.s1}>
                <Text style={styles.h1}>StepsSummaryView</Text>
    ...
    _renderItem = ({item}) => (
        <Text style={[styles.bgcList, styles.separator]}>{new Date(item.key.date).toDateString()} : {item.key.steps}</Text>
    );
